  ...
  <form class="flex h-12 w-full items-center rounded-3xl border border-solid border-brand-gray-3">
    ...
    <div class="flex h-full flex-1 flex-nowrap text-base font-light">
      <div class="relative flex h-full flex-1 items-center pr-3">
        ...
        <text-input placeholder="Carpenter" v-model="role" />
      </div>
      <span
      ...
      <div class="relative flex h-full flex-1 items-center pl-3">
        ...
        <text-input placeholder="Jepara" v-model="location" />
      </div>
    </div>
    <action-button btnText="Search" styleType="secondary" class="rounded-r-3xl" />
  </form>
</template>
